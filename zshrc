...
export ZSH="/home/lolus/.oh-my-zsh"
...
plugins=(bgnotify jsontools chucknorris git-prompt npm react-native gitignore)
...
export RPROMPT="%~  %B%w  %T%b"
export prompt="%B%n%b %F{green}%.%f "'$(git_super_status)'"🦎 "
